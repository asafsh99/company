...
class Salesperson(e.Employee):
    ...
    def __lt__(self, other):
        if int(self.__current_sales) == int(other.__current_sales):
            return f'same amount of sales'
        elif int(self.__current_sales) < int(other.__current_sales):
            return f'first salesperson has more programming language than second salesperson'
        return f'second salesperson has more programming language than first salesperson'
